 ...
 * necessary */
static void secp256k1_positive_pubkey_convert(const secp256k1_context* ctx, secp256k1_pubkey *pubkey, int *sign) {
   secp256k1_ge ge;
...
int secp256k1_positive_pubkey_create(const secp256k1_context* ctx, secp256k1_positive_pubkey *pubkey, const unsigned char *seckey) {
    ...
    secp256k1_positive_pubkey_convert(ctx, (secp256k1_pubkey *) pubkey, NULL);
    return 1;
}
...
int secp256k1_positive_pubkey_from_signed(const secp256k1_context* ctx, secp256k1_positive_pubkey *positive_pubkey, int *sign, const secp256k1_pubkey *pubkey) {
    ...
    *positive_pubkey = *(secp256k1_positive_pubkey *) pubkey;
    ...
    secp256k1_positive_pubkey_convert(ctx, (secp256k1_pubkey*) positive_pubkey, sign);
    return 1;
}
