...
void test_schnorrsig_taproot(void) {
    ...
    CHECK(secp256k1_keypair_pub_xonly(ctx, &output_pk, &pubkey_parity, &keypair) == 1);
    ...
    CHECK(secp256k1_xonly_pubkey_tweak_test(ctx, output_pk_bytes, pubkey_parity, &internal_pk, tweak) == 1);
}
