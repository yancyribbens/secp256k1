...
void test_aggsig_api(void) {
    ...
    secp256k1_scratch_space *scratch = secp256k1_scratch_space_create(none, 1024*4, 4096*4);
...
void test_aggsig_onesigner(void) {
    ...
    secp256k1_scratch_space *scratch = secp256k1_scratch_space_create(ctx, 1024*4, 4096*4);
