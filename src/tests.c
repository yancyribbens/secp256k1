...
void run_ecmult_multi_tests(void) {
    ...
    for (ncount = 0; ncount < count; ncount++) {
        ...
        secp256k1_ecmult_multi(&r, sc, pt, &szero, 1);
        ...
        secp256k1_ecmult_multi(&r, sc, pt, &szero, 2);
        secp256k1_gej_neg(&r2, &r2);
        secp256k1_gej_add_var(&r, &r, &r2, NULL);
        CHECK(secp256k1_gej_is_infinity(&r));
        ...
        secp256k1_ecmult(&ctx->ecmult_ctx, &r2, &pt[0], &sc[0], &sc[1]);
        secp256k1_ecmult_multi(&r, sc, pt, &sc[1], 1);
        secp256k1_gej_neg(&r2, &r2);
        secp256k1_gej_add_var(&r, &r, &r2, NULL);
        CHECK(secp256k1_gej_is_infinity(&r));
    }
    ...
    for (ncount = 0; ncount < count; ncount++) {
        ...
        for (j = 0; j < 3; j++) {
            ...
            secp256k1_ecmult_multi(&r, sc, pt, &szero, sizes[j]);
            CHECK(secp256k1_gej_is_infinity(&r));
        }
        ...
        secp256k1_ecmult_multi(&r, sc, pt, &szero, 32);
        CHECK(secp256k1_gej_is_infinity(&r));
    }
    ...
    for (ncount = 0; ncount < count; ncount++) {
        ...
        secp256k1_ecmult_multi(&r, sc, pt, &szero, 20);
        secp256k1_gej_neg(&r2, &r2);
        secp256k1_gej_add_var(&r, &r, &r2, NULL);
        CHECK(secp256k1_gej_is_infinity(&r));
    }
    ...
    secp256k1_ecmult_multi(&r, sc, pt, &szero, 6);
    secp256k1_ecmult_multi(&r, sc, pt, &szero, 5);
    CHECK(secp256k1_gej_is_infinity(&r));
            ...
            for(t1i = 0; t1i < TOP; t1i++) {
                ...
                for(s0i = 0; s0i < TOP; s0i++) {
                    for(s1i = 0; s1i < TOP; s1i++) {
                        ...
                        secp256k1_ecmult_multi(&actual, sc, pt, &szero, 2);
